    ...
    <div className="max-w-2xl mx-auto py-12 px-4">
      ...
      <div className="mt-10 text-center">
        <Link
          to="/"
          aria-label="返回首页"
          className="inline-block bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 text-white font-semibold px-6 py-3 rounded-lg transition-colors"
        >
          返回首页
        </Link>
      </div>
