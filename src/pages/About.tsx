    ...
    <div className="max-w-2xl mx-auto py-12 px-4">
      ...
      <div className="mt-10 text-center">
        <Link
          to="/"
          aria-label="返回首页"
          className="inline-block bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 text-white font-semibold px-6 py-3 rounded-lg transition-colors"
        >
          返回首页
        </Link>
      </div>
